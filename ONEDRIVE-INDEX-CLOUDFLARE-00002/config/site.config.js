...
module.exports = {
  ...
  userPrincipalName: process.env.USER_PRINCIPLE_NAME || 'torpedonucleardapesada@outlook.com',
  ...
  title: "mr robot 4 temporada part 2 OneDrive",
  ...
  email: 'mailto:torpedonucleardapesada@outlook.com',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/makarovagentstealth',
    },
  ],
